...
def inicio(request):
      ...
      return render(request, "AppGR/inicio.html")


def sombras(request):
      sombras = Sombras.objects.all()
      return render(request, "AppGR/sombras.html", {'sombras': sombras})


def base(request):
      base = base.objects.all()
      return render(request, "AppGR/base.html", {'base': base})


def brochas(request):
      brochas = brochas.objects.all()
      return render(request, "AppGR/brochas.html", {'brochas': brochas})
...
def sombras_formulario(request):
      if request.method == 'POST':
            ...
            if formulario.is_valid():
                  ...
                  sombras.save()
                  return render(request, "AppGR/inicio.html", {"exitoso": True})
      else:  
            formulario= SombrasForm()  
      return render(request, "AppGR/form_sombras.html", {"formulario": formulario})



def busqueda_sombras(request):
      return render(request, "AppGR/form_busqueda_sombras.html")
...
def buscar_sombras(request):
      if request.GET["codigo"]:
            ...
            return render(request, "AppGR/sombras.html", {'sombras': []})
...
def base_formulario(request):
      ...
      return render(request, "AppGR/form_base.html", {"formulario": formulario1})

def busqueda_base(request):
            return render(request, "AppGR/form_busqueda_base.html")
...
def buscar_base(request):
      if request.GET["codigo"]:
            ...
            return render(request, "AppGR/base.html", {'base': []})
...
def brochas_formulario(request):
      ...
      return render(request, "AppGR/form_brochas.html", {"formulario": formulario2})

def busqueda_brochas(request):
            return render(request, "AppGR/form_busqueda_brochas.html")
...
def buscar_brochas(request):
      if request.GET["numero"]:
            ...
            return render(request, "AppGR/brochas.html", {'brochas': []})